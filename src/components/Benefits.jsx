...
import cardHairGrowth from '../assets/figma/card-hair-growth.png'
import cardStressReduction from '../assets/figma/card-stress-reduction.png'
  ...
  return (
    <section className="relative overflow-hidden bg-cream py-16">
      ...
      <div className="relative mt-14">
        <div
          ref={scrollerRef}
          className="flex gap-4 overflow-x-auto scroll-smooth px-6 py-10 [scrollbar-width:none] md:px-[calc((100vw-1376px)/2)] [&::-webkit-scrollbar]:hidden"
        >
        {cards.map((c, i) => (
          <motion.div
            key={c.title}
